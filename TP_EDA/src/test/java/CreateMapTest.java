...
class CreateMapTest {
    ...
    void testFindPath() {
        ...
        map.addStation(5,"130",-34.58829487351996,-58.38286818192071 ,1);
        map.addStation(6,"130",-34.59018501549182,-58.379563700414366,1);
        map.addStation(7,"131",-34.59838628851389,-58.37129094944708,1);
        map.addStation(8,"131",-34.59838628851389,-58.37129094944708,1);
        map.addStation(9,"10",-34.59328154388841,-58.37431648121588,1);

        List<BusInPath> result1 = map.graph.findPath(-34.57548058966485,-58.48892596672341,-34.59838628851389,-58.37129094944708); //hasta echeverria
